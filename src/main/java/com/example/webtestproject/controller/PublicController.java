...
@Slf4j
@RequestMapping("/b2c/sojang/v1/public")
public class PublicController {
	...
	@GetMapping("/holiday")
	public ApiResponse<Boolean> getNotificationsList(
		...
		@RequestParam(value = "solYear", required = false, defaultValue = "10") int solYear,
